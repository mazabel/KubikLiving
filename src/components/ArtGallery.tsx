...
export function ArtGallery() {
  ...
  return (
    <section id="arte" className="py-24 md:py-32 bg-[#0e0e0e] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-16 flex items-end justify-between gap-8">
          <div>
            <p className="text-[10px] tracking-[0.3em] text-white/30 uppercase font-light mb-3">
              Arte & Comunidad
            </p>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold uppercase text-white/90 leading-none">
              Colecciones<br />de artistas locales
            </h2>
          </div>
          <p className="hidden md:block text-xs text-white/30 font-light text-right max-w-xs leading-relaxed">
            Cada corredor y espacio común es una galería viva que celebra el talento emergente de Bogotá.
          </p>
        </div>
